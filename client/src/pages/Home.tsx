...
export default function Home() {
  ...
  return (
    <MobileShell className="bg-[#1c2631] text-white">
      ...
      {/* Chat List simulating Mini App Launchers */}
      <div className="flex flex-col">
        {apps.map((app) => (
          <Link key={app.id} href={app.route}>
            <a className="flex items-center gap-3 border-b border-white/5 bg-[#1c2631] px-4 py-3 hover:bg-[#242f3d] transition-colors">
        ...
        {/* Filler chats to look authentic */}
        {[1, 2, 3, 4].map((i) => (
